...
import ResultPHP from './ResultPHP'; 
import './FetchQuizPHP.css';
import { db } from '../firebase';
import { ref, get } from 'firebase/database';

function FetchQuizPHP({ updateScoreInHome }) {
  ...
  return (
    <div className="quiz-containar">
      <div className="cuuntainer">
        {showResult ? (
          <ResultPHP score={score} subjectPassed={subjectPassed} totalScore={questions.length} tryAgain={resetAll} />
        ) : questions.length > 0 ? (
          <>
